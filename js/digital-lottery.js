export default function digitalLottery($inputLottery, 
    $winnerLottery, 
    $buttonSendLottery, 
    $itemsLottery,
    $btnWinnerLottery,
    ...
    $buttonSendLottery.addEventListener("click", (e)=> {
        console.log($inputLottery.value);
